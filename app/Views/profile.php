...
<body>
    ...
    <header>
            ...
            <div class="nav-icon">
                ...
                <a href="cartada"><i class='bx bx-cart'></i></a>
                        <!-- Logout Link -->
                        <a href="<?= base_url('logout'); ?>" class="edit-button">Logout</a>
    ...
    <div class="container">
        <div class="profile-section">
            ...
            <p><strong>Account:</strong> <?= esc($user['email']); ?></p>
            <p><strong>Name:</strong> <?= esc($user['first_name']) . ' ' . esc($user['last_name']); ?></p>
            <p><strong>Telp:</strong> <?= esc($user['no_hp']); ?></p>
            <p><strong>Address:</strong> <?= esc($user['alamat']); ?></p>
