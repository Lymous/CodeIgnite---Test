        ...
        <style>
            *{
            ...
            @media (max-width: 768px) {
                ...
                .total-section h3, .total-section .total-price {
                    margin-bottom: 10px;
                }
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="total-section">
                <h3>Total Harga:</h3>
                <div class="total-price">Rp. <?php $total = 0; foreach ($carts as $cart) { $total += $cart['harga']; } ?><?= $total ?></div>
            </div>

            <!-- Pay Button -->
            <div style="text-align: center; margin-top: 30px;">
                <a href="payment" class="pay-button">Bayar</a>
            </div>
